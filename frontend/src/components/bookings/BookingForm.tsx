    ...
    <form action={formAction} className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        ...
        <div className="space-y-4">
          <div>
            <label htmlFor="motorcycle_brand" className="block text-sm font-medium text-gray-700 mb-2">
          ...
          <div>
            <label htmlFor="motorcycle_model" className="block text-sm font-medium text-gray-700 mb-2">
            ...
            <input
              ...
              required
              placeholder="Contoh: Vario 150, NMAX, Satria FU"
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>

          <div>
            <label htmlFor="motorcycle_plate" className="block text-sm font-medium text-gray-700 mb-2">
