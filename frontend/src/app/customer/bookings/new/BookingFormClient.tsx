...
// Icon mapping untuk service yang umum, fallback ke wrench jika tidak ada
const serviceIcons: Record<string, string> = {
  ...
  'Tune Up': 'fa-gauge-high',
  'Ganti Aki': 'fa-car-battery',
  'Ganti Filter': 'fa-filter',
  'Cuci Motor': 'fa-soap',
};
      ...
      <div className="w-[380px] sticky top-6 space-y-5">
        <div className="bg-white rounded-2xl p-6 shadow-sm">
          ...
          <div className="flex gap-3">
            ...
            >
              Konfirmasi Pesanan
              <i className="fa-solid fa-arrow-right" suppressHydrationWarning></i>
            </button>
          </div>
        </div>

        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex gap-3">
          <i className="fa-solid fa-shield-check text-blue-600 text-lg mt-0.5" suppressHydrationWarning></i>
          <div>
