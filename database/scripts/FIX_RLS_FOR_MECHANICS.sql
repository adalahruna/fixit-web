-- FIX: Use SECURITY DEFINER for atomic functions
...
SECURITY DEFINER  -- Run with function owner's permissions, bypass RLS
...
BEGIN
  ...
  -- Atomic update: BOTH tables (RLS bypassed with SECURITY DEFINER)
...
-- Verify
SELECT 'Functions recreated with SECURITY DEFINER' as status;
